      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{gap : spacingY._20, paddingTop : spacingY._5, paddingBottom : verticalScale(100),}} showsVerticalScrollIndicator = {false}>
          ...
          <View style={styles.chartContainer}>
            {
              chartData.length > 0 ? (
                  <BarChart data={chartData} barWidth={scale(12)} spacing={[1,2].includes(activeIndex) ? scale(25) : scale(16)} hideRules yAxisLabelPrefix='$' yAxisThickness={0} xAxisThickness={0} yAxisLabelWidth={[1,2].includes(activeIndex) ? scale(38) : scale(35)}
          ...
          <View>
            <TransactionList title='Transactions' emptyListMessage='Transactions not found' data={transactions}/>
          </View>
        </ScrollView>
